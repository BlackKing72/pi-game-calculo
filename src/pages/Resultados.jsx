...
const Resultados = () => {
    ...
    return (
        <div className="w-screen h-full min-h-[100dvh] flex flex-col items-center justify-center ">
            <div className="w-full flex flex-col flex-grow gap-4 max-w-[50ch] bg-slate-50 justify-center p-4">
                <div className="bg-slate-200 rounded-lg p-10 flex flex-col gap-4 items-center">
